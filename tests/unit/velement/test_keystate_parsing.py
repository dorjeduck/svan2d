...
def state1():
    """First sample state"""
    return CircleState(Point2D(), radius=50)


@pytest.fixture
def state2():
    """Second sample state"""
    return CircleState(Point2D(100, 100), radius=75)


@pytest.fixture
def state3():
    """Third sample state"""
    return CircleState(pos=Point2D(200, 200), radius=100)
...
class TestElementKeystatesParsingBareStates:
    ...
    def test_parse_four_bare_states(self, state1, state2, state3):
        ...
        state4 = CircleState(pos=Point2D(300, 300), radius=125)
...
class TestElementKeystatesParsingMixed:
    ...
    def test_parse_implicit_between_explicit(self, state1, state2, state3):
        ...
        state_middle = CircleState(Point2D(50, 50), radius=60)
        keystates = [
            (0.2, state1),
    ...
    def test_parse_multiple_implicit_between_explicit(self, state1, state2, state3):
        ...
        state4 = CircleState(Point2D(150, 150), radius=80)
        keystates = [
            (0.0, state1),
            state2,
            state3,
...
@pytest.mark.unit
class TestFieldKeystatesParsingBareValues:
    """Test parsing field keystates with bare values"""

    def test_parse_single_value(self):
        """Test parsing single field value"""
        keystates = [Color("#FF0000")]
        result = parse_attribute_keystates(keystates)
    ...
    def test_parse_three_values(self):
        """Test parsing three field values"""
        values = [100, 200, 300]
        keystates = values
        result = parse_attribute_keystates(keystates)
...
@pytest.mark.unit
class TestFieldKeystatesParsingTuples:
    """Test parsing field keystates with tuples"""
    ...
    def test_parse_partial_timeline_extends(self):
        """Test that field keystates always extend to full timeline"""
        keystates = [
            (0.3, 100),
            (0.7, 200),
        ]
...
@pytest.mark.unit
class TestFieldKeystatesParsingMixed:
    """Test parsing mixed field keystate formats"""
...
class TestKeystateParsingEdgeCases:
    ...
    def test_parse_empty_attribute_keystates_raises(self):
        """Test that empty field keystates list raises error"""
        with pytest.raises(ValueError, match="field keystates cannot be empty"):
            parse_attribute_keystates([])
    ...
    def test_parse_many_keystates(self, state1):
        ...
        states = [CircleState(Point2D(i * 10, i * 10), radius=50) for i in range(20)]
...
@pytest.mark.unit
class TestFieldKeystateValueEasingTuples:
