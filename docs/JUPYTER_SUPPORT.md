...
Svan2D provides comprehensive support for Jupyter notebooks, making it easy to create, preview, and test SVG animations interactively.
...
Svan2D offers two ways to preview animations in Jupyter without exporting to video - perfect for fast iteration and testing.
...
Svan2D uses a **centered coordinate system** by default:
...
The centered coordinate system is configured via `svan2d.toml` and applies consistently across all display methods.
...
5. **Restart kernel** after updating Svan2D code to clear cached display methods
...
For more information about Svan2D's animation system, see the main [README](../README.md).
