...
class TestLineLayout:
    ...
    def test_line_layout_basic(self):
        ...
        positioned = layout.line(states, spacing=100, rotation=0, center=Point2D())
...
@pytest.mark.unit
class TestLayoutPreservesFields:
    """Test that layouts preserve non-position attributes"""

    def test_layout_preserves_radius(self):
        """Test that layout preserves radius field"""
    ...
    def test_layout_preserves_colors(self):
        """Test that layout preserves color attributes"""
