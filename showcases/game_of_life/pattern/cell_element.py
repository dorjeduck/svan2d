...
def create_cell_element(
    ...
    grid_size: int,
    generations: int,
    scene_size: float = 600,  # Smaller of scene width/height
) -> VElement | None:
    ...
    # Calculate cell size to fit grid within scene
    # Leave some margin (90% of scene)
    available = scene_size * 0.9
    cell_spacing = available / grid_size
    cell_size = max(1, cell_spacing - CELL_GAP)
