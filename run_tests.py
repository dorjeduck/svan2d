#!/usr/bin/env python3
"""
Comprehensive test runner script for Svan2D project.
...
def main():
    parser = argparse.ArgumentParser(description="Run Svan2D tests")
    parser.add_argument(
        "--all", action="store_true", help="Run all tests including slow"
    )
    ...
    parser.add_argument(
        "--quick", action="store_true", help="Quick run without coverage"
    )
    parser.add_argument(
