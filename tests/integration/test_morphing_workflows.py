...
class TestTransformAnimations:
    ...
    def test_position_and_morph_combined(self):
        ...
        state1 = CircleState(pos=Point2D(-100, -100), radius=50, _num_vertices=64)
...
class TestEasingIntegration:
    ...
    def test_per_attribute_easing(self):
        """Test morphing with per-field easing"""
...
class TestFieldKeystates:
    """Test field -level keystates override"""

    def test_field_keystate_override(self):
        """Test overriding specific field with field keystates"""
        state1 = CircleState(Point2D(), radius=50, _num_vertices=64)
    ...
    def test_multiple_attribute_keystates(self):
        """Test overriding multiple attributes"""
        state1 = CircleState(
            Point2D(), radius=50, fill_color=Color("#FF0000"), _num_vertices=64
        )
        state2 = CircleState(
            pos=Point2D(200, 200),
            radius=100,
