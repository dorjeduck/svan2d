# ============================================================================
# svan2D/animations/compound/rotate_flip.py
# ============================================================================
...
def rotate_flip(
    ...
    Example:
        >>> from svan2D.animations.compound import rotate_flip
    ...
    keyframes1 = [
        ...
        KeyState(
            time=t_mid,
            state=replace(state1, rotation=orig_rot_1 + angle / 2, opacity=0.0),
        ),
    ]
    ...
    keyframes2 = [
        KeyState(
            time=t_mid,
            state=replace(state2, rotation=orig_rot_2 - angle / 2, opacity=0.0),
        ),
