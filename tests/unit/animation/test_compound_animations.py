...
from svan2d.component.state import CircleState, RectangleState, StarState
from svan2d.core.color import Color
from svan2d.animation.compound import (
    crossfade,
    bounce_replace,
    scale_swap,
    slide_replace,
...
class TestCrossfadeAnimation:
    ...
    def test_crossfade_opacity_transition(self):
        ...
        state1 = CircleState(Point2D(), radius=50, opacity=1.0)
        state2 = CircleState(Point2D(100, 100), radius=75, opacity=1.0)
    ...
    def test_crossfade_different_shapes(self):
        ...
        state2 = RectangleState(Point2D(100, 100), width=80, height=80)
...
class TestBounceReplaceAnimation:
    ...
    def test_bounce_replace_with_custom_height(self):
        ...
        keystates1, keystates2 = bounce_replace(
            state1, state2, bounce_height=-75, duration=0.4
        )
...
class TestScaleSwapAnimation:
    ...
    def test_scale_swap_opposite_directions(self):
        ...
        keystates1, keystates2 = scale_swap(state1, state2, min_scale=0.0, duration=0.3)
...
class TestSlideReplaceAnimation:
    ...
    def test_slide_replace_right(self):
        ...
        state1 = CircleState(Point2D(), radius=50)
        state2 = RectangleState(Point2D(), width=80, height=60)

        keystates1, keystates2 = slide_replace(
            state1, state2, direction="right", distance=200, duration=0.3
        )
    ...
    def test_slide_replace_left(self):
        ...
        state2 = RectangleState(pos=Point2D(100, 0), width=80, height=60)

        keystates1, keystates2 = slide_replace(
            state1, state2, direction="left", distance=150, duration=0.3
        )
    ...
    def test_slide_replace_up(self):
        ...
        keystates1, keystates2 = slide_replace(
            state1, state2, direction="up", distance=100, duration=0.3
        )
    ...
    def test_slide_replace_down(self):
        ...
        keystates1, keystates2 = slide_replace(
            state1, state2, direction="down", distance=100, duration=0.3
        )
...
class TestRotateFlipAnimation:
    ...
    def test_rotate_flip_clockwise(self):
        ...
        keystates1, keystates2 = rotate_flip(state1, state2, angle=180, duration=0.5)
...
class TestCompoundAnimationEdgeCases:
    ...
    def test_slide_replace_zero_distance(self):
        ...
        keystates1, keystates2 = slide_replace(
            state1, state2, direction="right", distance=0, duration=0.3
        )
