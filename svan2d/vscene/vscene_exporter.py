...
"""
    ...
    def _to_frames_parallel(
        ...
        logger.info(
            f"Generating {total_frames} PNG frames with {parallel_workers} parallel workers"
        )
        ...
        # Phase 2: Convert all SVGs to PNGs in parallel
        logger.info(f"Phase 2: Converting {total_frames} SVGs to PNG...")
        png_start = time.time()
