...
class TestInterpolationPerformance:
    ...
    def test_state_interpolation_simple(self, benchmark):
        ...
        state2 = CircleState(Point2D(100, 100), radius=100)
...
class TestVElementPerformance:
    ...
    def test_velement_with_attribute_keystates(self, benchmark):
        """Benchmark VElement with field keystate overrides"""
        states = [
            CircleState(Point2D(), radius=50),
