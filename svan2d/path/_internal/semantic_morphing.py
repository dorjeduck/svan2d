...
def calculate_centroid(path: SVGPath) -> Point2D:
...
def find_closest_point_to_target(path: SVGPath, target: Point2D) -> int:
...
def feature_preserving_normalize(
    ...
    """
    from svan2d.path._internal.normalization import normalize_paths_for_morphing
