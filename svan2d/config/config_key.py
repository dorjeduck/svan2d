...
class ConfigKey(str, Enum):
    ...
    # Resvg server configuration
    RESVG_SERVER_HOST = "resvg_server.host"
    RESVG_SERVER_PORT = "resvg_server.port"
    RESVG_SERVER_AUTO_START = "resvg_server.auto_start"
    RESVG_SERVER_LOG_LEVEL = "resvg_server.log_level"
