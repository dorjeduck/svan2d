...
class TestCircleRenderer:
    ...
    def test_render_circle_with_transforms(self):
        ...
        state = CircleState(
            Point2D(100, 100), radius=50, scale=2.0, rotation=45, opacity=0.5
        )
        renderer = CircleRenderer()
        element = renderer.render(state)
...
class TestRectangleRenderer:
    ...
    def test_render_rectangle_with_rotation(self):
        ...
        state = RectangleState(Point2D(100, 100), width=150, height=80, rotation=30)
        renderer = RectangleRenderer()
        element = renderer.render(state)
...
class TestPolygonRenderer:
    ...
    def test_render_octagon(self):
        ...
        state = PolygonState(Point2D(100, 100), size=50, num_sides=8)
        renderer = PolygonRenderer()
        element = renderer.render(state)
...
class TestTextRenderer:
    ...
    def test_render_text_basic(self):
        ...
        state = TextState(Point2D(100, 100), text="Hello World")
    ...
    def test_render_text_with_font_size(self):
        ...
        state = TextState(Point2D(100, 100), text="Hello", font_size=48)
        renderer = TextRenderer()
        element = renderer.render(state)
...
class TestRendererTransforms:
    ...
    def test_renderer_applies_rotation(self):
        ...
        state = RectangleState(Point2D(100, 100), width=100, height=60, rotation=45)
        renderer = RectangleRenderer()
        element = renderer.render(state)
    ...
    def test_renderer_applies_scale(self):
        ...
        state = CircleState(Point2D(100, 100), radius=50, scale=2.0)
        renderer = CircleRenderer()
        element = renderer.render(state)
    ...
    def test_renderer_applies_opacity(self):
        ...
        state = CircleState(Point2D(100, 100), radius=50, opacity=0.5)
        renderer = CircleRenderer()
        element = renderer.render(state)
...
class TestRendererConsistency:
    ...
    def test_circle_renderers_produce_similar_output(self):
        ...
        state = CircleState(Point2D(100, 100), radius=50, _num_vertices=64)
