...
class TestConfigLoading:
    ...
    def test_load_defaults(self):
        ...
        config = Svan2DConfig.load_defaults()
...
"""
        ...
        config = Svan2DConfig.load_from_file(config_file)
    ...
    def test_load_from_missing_file_raises(self, temp_config_dir):
        ...
        with pytest.raises(FileNotFoundError, match="Config file not found"):
            Svan2DConfig.load_from_file(missing_file)
...
"""
        ...
        with pytest.raises(tomllib.TOMLDecodeError):
            Svan2DConfig.load_from_file(malformed_file)
...
"""
        ...
        config = Svan2DConfig.load_with_overrides(user_config)
    ...
    def test_load_with_missing_user_config_uses_defaults(self):
        ...
        config = Svan2DConfig.load_with_overrides(
            user_config_path="/nonexistent/path.toml"
        )
...
class TestConfigMerging:
    ...
    def test_merge_nested_dicts(self):
        ...
        override_dict = {"state": {"visual": {"fill_color": "#00FF00"}}}
    ...
    def test_merge_replaces_non_dict_values(self):
        ...
        base_dict = {"state": {"pos": Point2D(0, 0)}}
        override_dict = {"state": {"pos": Point2D(100, 0)}}

        config = Svan2DConfig(base_dict)
        config._merge(override_dict)

        assert config._config["state"]["pos"] == Point2D(100, 0)
...
class TestConfigGet:
    ...
    def test_get_simple_value(self):
        ...
        config = Svan2DConfig(config_dict)
...
class TestConfigToDictconverts:
    ...
    def test_to_dict_includes_all_values(self):
        ...
        assert exported["state"]["pos"] == Point2D()
...
""",
    ...
    def test_very_nested_config(self):
        ...
        config_dict = {"level1": {"level2": {"level3": {"level4": {"value": 42}}}}}
        config = Svan2DConfig(config_dict)
